...
import com.example.bottomnavigation.service.AlarmReceiver;
import com.example.bottomnavigation.service.LoadAlarmsService;
import com.example.bottomnavigation.util.ViewUtils;
...
public final class AddEditAlarmFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        com.example.bottomnavigation.util.ViewUtils.setTimePickerTime(mTimePicker, alarm.getTime());
    ...
    private void save() {
        ...
        time.set(Calendar.MINUTE, com.example.bottomnavigation.util.ViewUtils.getTimePickerMinute(mTimePicker));
